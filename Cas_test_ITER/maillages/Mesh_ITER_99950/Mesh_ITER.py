...
sys.path.insert(0, r'D:/Logiciels/FESTIM_4_JONATHAN/Cas_test_ITER/maillages/Mesh_ITER_99950')
...
[Ar__te_1,Ar__te_2,Ar__te_3,Ar__te_4,Ar__te_5,Ar__te_6,Ar__te_7,Ar__te_8,Ar__te_9,Ar__te_10,Ar__te_11,Ar__te_12,Ar__te_13,Ar__te_14,Ar__te_15] = geompy.ExtractShapes(Partition_1, geompy.ShapeType["EDGE"], True)
...
Auto_group_for_Sous_maillage_1 = geompy.CreateGroup(Partition_1, geompy.ShapeType["EDGE"])
geompy.UnionList(Auto_group_for_Sous_maillage_1, [Ar__te_3, Ar__te_5, Ar__te_6, Ar__te_7])
...
geompy.addToStudyInFather( Partition_1, Ar__te_1, 'Arête_1' )
geompy.addToStudyInFather( Partition_1, Ar__te_2, 'Arête_2' )
geompy.addToStudyInFather( Partition_1, Ar__te_3, 'Arête_3' )
geompy.addToStudyInFather( Partition_1, Ar__te_4, 'Arête_4' )
geompy.addToStudyInFather( Partition_1, Ar__te_5, 'Arête_5' )
geompy.addToStudyInFather( Partition_1, Ar__te_6, 'Arête_6' )
geompy.addToStudyInFather( Partition_1, Ar__te_7, 'Arête_7' )
geompy.addToStudyInFather( Partition_1, Ar__te_8, 'Arête_8' )
geompy.addToStudyInFather( Partition_1, Ar__te_9, 'Arête_9' )
geompy.addToStudyInFather( Partition_1, Ar__te_10, 'Arête_10' )
geompy.addToStudyInFather( Partition_1, Ar__te_11, 'Arête_11' )
geompy.addToStudyInFather( Partition_1, Ar__te_12, 'Arête_12' )
geompy.addToStudyInFather( Partition_1, Ar__te_13, 'Arête_13' )
geompy.addToStudyInFather( Partition_1, Ar__te_14, 'Arête_14' )
geompy.addToStudyInFather( Partition_1, Ar__te_15, 'Arête_15' )
geompy.addToStudyInFather( Partition_1, Auto_group_for_Sous_maillage_1, 'Auto_group_for_Sous-maillage_1' )
...
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
Regular_1D_2_4 = Mesh_1.Segment(geom=Auto_group_for_Sous_maillage_1)
Local_Length_1 = Regular_1D_2_4.LocalLength(5e-05,None,1e-08)
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
Local_Length_1.SetLength( 3e-05 )
Local_Length_1.SetPrecision( 1e-08 )
isDone = Mesh_1.Compute()
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
smesh.SetName(Mesh_1, 'Mesh_1')
try:
  Mesh_1.ExportMED(r'D:/Logiciels/FESTIM_4_JONATHAN/Cas_test_ITER/maillages/Mesh_ITER_99950/Mesh_ITER.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=1)
  pass
except:
  print('ExportMED() failed. Invalid file name?')
...
Material_interface = Regular_1D_2_4.GetSubMesh()
...
smesh.SetName(Material_interface, 'Material interface')
