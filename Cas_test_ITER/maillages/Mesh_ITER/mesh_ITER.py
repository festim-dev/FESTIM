...
sys.path.insert(0, r'M:/GitHub/FESTIM_4_JONATHAN/Cas_test_ITER/maillages/MESH ITER')
...
Disk_1 = geompy.MakeDiskR(0.0085, 1)
...
#status = Mesh_1.AddHypothesis(smeshObj_1,heat_flux) ### smeshObj_1 has not been yet created
Regular_1D_2_1 = Mesh_1.Segment(geom=coolant)
#status = Mesh_1.AddHypothesis(smeshObj_2,coolant) ### smeshObj_2 has not been yet created
...
#Mesh_1.GetMesh().RemoveSubMesh( left_2 ) ### left_2 has not been yet created
...
Start_and_End_Length_1 = Regular_1D_2_2.StartEndLength(0.0021838,5e-06,[])
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
...
try:
  Mesh_1.ExportMED(r'/home/rdelaporte/FESTIM_4_JONATHAN/Cas_test_ITER/maillages/Mesh 10/mesh_10.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=1)
  pass
except:
...
smesh.SetName(Mesh_1, 'Mesh_1')
try:
  Mesh_1.ExportMED(r'/home/rdelaporte/FESTIM_4_JONATHAN/Cas_test_ITER/maillages/Mesh 10/mesh_10b.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=1)
  pass
except:
  print('ExportMED() failed. Invalid file name?')
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
Start_and_End_Length_2 = Regular_1D_2.StartEndLength(5e-07,5e-06,[])
[ cucrzr_1, cu_1, tungsten_1, heat_flux_1, coolant_1, left_1, bottom_1, middle_1 ] = Mesh_1.GetGroups()
...
try:
  ...
  print('ExportMED() failed. Invalid file name?')
Start_and_End_Length_1.SetStartLength( 0.0021838 )
...
Start_and_End_Length_2.SetStartLength( 9e-08 )
Start_and_End_Length_2.SetEndLength( 5e-05 )
