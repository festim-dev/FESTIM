...
The FESTIM Fellowship Programme is a focused, hands-on programme designed to help users with prior FESTIM experience develop a deep, practical understanding of the code and its capabilities.

Fellows work closely with the FESTIM development team, either remotely or in person at the MIT Plasma Science and Fusion Center (PSFC). Each Fellow brings a focused project, which serves as the main vehicle for exploring FESTIM in depth through a real application.

The programme is centred on learning how to use FESTIM effectively and confidently: structuring simulations, leveraging advanced features, understanding how the code operates, and troubleshooting complex cases. The goal is to enable Fellows to return to their institution or organisation as advanced users of FESTIM, capable of independently developing and supporting simulation work.
...
We welcome applicants from academia, research institutions, and industry who want to deepen their expertise and become key FESTIM users within their organisation.
