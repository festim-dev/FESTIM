...
class Interface():
    ...
    def compute_mapped_interior_facet_data(self, mesh):
        ...
        integration_data = compute_integration_domains(
            dolfinx.fem.IntegralType.interior_facet, mesh.topology, self.mt.find(self.id), self.mt.dim)
        ...
        domain1_cell = self.subdomains[1].parent_to_submesh[ordered_integration_data[:, 2]]
