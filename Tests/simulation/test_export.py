...
def test_output_of_run_without_traps_no_chemical_pot():
    ...
    my_sim.update_post_processing_solutions()
...
#     my_sim.mobile.post_processing_solution = fenics.Function(V_DG1)
#     my_temp = FESTIM.Temperature("solve_stationary")
#     my_temp.T = fenics.Function(V_CG1)
#     my_sim.T = my_temp
#     my_sim.V_DG1 = V_DG1
...
#         my_sim.mobile, my_sim.traps, my_sim.T, my_sim.settings,
#         my_sim.initial_conditions)
#     my_sim.h_transport_problem.V = V_CG1
#     my_sim.h_transport_problem.initialise_concentrations()
#     my_sim.mobile.create_form_post_processing(V_DG1, my_mats, fenics.dx())
...
def test_output_of_run_with_traps_with_chemical_pot():
    ...
    materials = FESTIM.Materials([
        FESTIM.Material(1, 1, 0, S_0=3, E_S=0)
    ])
    vm = fenics.MeshFunction("size_t", mesh, 2, 1)
    dx = fenics.Measure("dx", domain=mesh, subdomain_data=vm)
    ...
    my_sim.mobile.solution = solute
    my_sim.mobile.create_form_post_processing(V_DG1, materials, dx)
