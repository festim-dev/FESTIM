...
class TestNeutronInducedTrapVaryingK:
    """
    Test for NeutronInducedTrap class, with varying K with time
    """
    form_prms = {
        "phi": 1,
        "K": 1+20*FESTIM.t,
...
class TestNeutronInducedTrapVaryingNmax:
    """
    Test for NeutronInducedTrap class, with varying n_max with time
    """
    form_prms = {
        "phi": 1,
        "K": 1,
...
class TestNeutronInducedTrapVaryingA0:
    """
    Test for NeutronInducedTrap class, with varying A_0 with time
    """
    form_prms = {
        "phi": 1,
        "K": 1,
...
class TestNeutronInducedTrapVaryingEa:
    """
    Test for NeutronInducedTrap class, with varying E_A with time
    """
    form_prms = {
        "phi": 1,
        "K": 1,
